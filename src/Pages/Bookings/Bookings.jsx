...
const Bookings = () => {
    ...
    const url = `https://car-solution-server-8i7iupbny-maruf-hussain.vercel.app/bookings?email=${user?.email}`;
    ...
    const handleDelete = id => {
        ...
        if (proceed) {
            fetch(`https://car-solution-server-8i7iupbny-maruf-hussain.vercel.app/bookings/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(data => {
